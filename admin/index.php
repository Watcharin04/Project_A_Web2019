    ...
    <div class="container-fluid p-y-md">
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3">
                <a class="card" href="post_active.php">
                    <div class="card-block clearfix">
                        <div class="pull-right">
                            <p class="h6 text-muted m-t-0 m-b-xs">Active Post</p>
            ...
            <div class="col-sm-6 col-lg-3">
                <a class="card bg-green bg-inverse" href="post_pending.php">
                    <div class="card-block clearfix">
                        <div class="pull-right">
                            <p class="h6 text-muted m-t-0 m-b-xs">New Post</p>
            ...
            <!-- .col-sm-6 -->
            <div class="col-sm-6 col-lg-3">
                <a class="card bg-purple bg-inverse" href="users.php">
                    <div class="card-block clearfix">
                        <div class="pull-right">
            ...
            <div class="col-sm-6 col-lg-3">
                <a class="card bg-blue bg-inverse" href="transactions.php">
                    <div class="card-block clearfix">
                        <div class="pull-right">
