...
<head>
    ...
    <!-- Document title -->
    <title><?php echo $config['site_title'] ?> - Rubhew Admin</title>
        ...
        <aside class="app-layout-drawer">
            ...
            <div class="app-layout-drawer-scroll">
                ...
                <nav class="drawer-main">
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item nav-item-has-subnav">
                            <a href="#"><i class="ion-image"></i> Post</a>
                            <ul class="nav nav-subnav">
                                <li><a href="post_active.php">Active Post</a></li>
                                <li><a href="post_pending.php">Pending Post</a></li>
                                <li><a href="post_hidden.php">Hidden by user</a></li>
                                <li><a href="post_resubmit.php">Resubmited Post</a></li>
                                <li><a href="post_expire.php">Expire Post</a></li>
                                <li><a href="posts.php">All Post List</a></li>
                            </ul>
                        </li>
                        <li class="nav-item nav-item-has-subnav">
                        ...
                        <li class="nav-item">
                            <a  href="chating.php"><i class="fa fa-weixin"></i> Messages</a>
                        </li>
                        <!-- <li class="nav-item nav-item-has-subnav">
                ...
                <div class="drawer-footer">
                    <p class="copyright"><a href="https://rubhew.in.th" target="_blank">Rubhew EiEi</a> &copy;</p>
                    <p class="copyright">Version : <?php echo "99" ?></p>
                </div>
            </div>
